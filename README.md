...
# Project 2 - MovieWatch

MovieWatch is a movies app displaying box office and top rental DVDs using [The Movie Database API](http://docs.themoviedb.apiary.io/#).
...
- [X] List anything else that you can get done to improve the app functionality!
On the detail view controller, if I swipe right, the title and the overview appears and if I swipe left, they disappear.
...
<img src='http://i.imgur.com/poAJkIG.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
